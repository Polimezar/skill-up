...
var _initMapPins = require("./modules/map/init-map-pins");
var _initMap2 = require("./modules/map/init-map-3");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _initMap.initMap)();
    (0, _initMapPins.initMapPins)();
    (0, _initMap2.initMapThree)();
...
},{"./init-map-zoom":10}],9:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initMapPins = void 0;
var initMapPins = function initMapPins() {
  var maps = document.querySelector('[data-map=map-pins]');
  if (!maps) {
    return;
  }
  ymaps.ready(function () {
...
exports.initMapPins = initMapPins;
