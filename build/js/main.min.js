...
var _initShowHeader = require("./modules/init-show-header");
var _initMap = require("./modules/map/init-map");
var _initMap2 = require("./modules/map/init-map-2");
var _initMap3 = require("./modules/map/init-map-3");
var _initLoader = require("./modules/init-loader");
var _initAnimateIntro = require("./modules/animation/init-animate-intro");
var _initCurtainsAnimation = require("./modules/animation/init-curtains-animation");
var _initAnimateFade = require("./modules/animation/init-animate-fade");
var _initAnimateScroll = require("./modules/animation/init-animate-scroll");
// открытие меню
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    (0, _initShowHeader.initShowHeader)();
    (0, _initMap.initMap)();
    (0, _initMap2.initMapTwo)();
    (0, _initMap3.initMapThree)();
    (0, _initAnimateIntro.initAnimateIntro)();
    (0, _initCurtainsAnimation.curtainsAnimation)();
    (0, _initAnimateFade.initAnimateFade)();
    (0, _initAnimateScroll.initAnimateScroll)();
  });
});
...
},{"./modules/animation/init-animate-fade":2,"./modules/animation/init-animate-intro":3,"./modules/animation/init-animate-scroll":4,"./modules/animation/init-curtains-animation":5,"./modules/init-loader":6,"./modules/init-show-header":7,"./modules/map/init-map":11,"./modules/map/init-map-2":8,"./modules/map/init-map-3":9,"./utils/ios-vh-fix":13}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initAnimateFade = void 0;
var _gsap = require("../../vendor/gsap.min");
var _ScrollTrigger = require("../../vendor/ScrollTrigger.min");
var initAnimateFade = function initAnimateFade() {
  var elements = document.querySelectorAll('[data-fade]');
  var elementsScale = document.querySelectorAll('[data-fade-scale]');
  var scale = document.querySelectorAll('[data-scale]');
  var transform = document.querySelectorAll('[data-transform]');
  if (!elements.length) {
    return;
  }
  window.gsap.set(elementsScale, {
    scale: 0.1
  });
  _ScrollTrigger.ScrollTrigger.batch(elementsScale, {
    onEnter: function onEnter(batch) {
      return window.gsap.to(batch, {
        scale: 1,
        duration: 1,
        stagger: 0.3,
        ease: 'slow'
  ...
  _ScrollTrigger.ScrollTrigger.batch(elements, {
    onEnter: function onEnter(batch) {
      return window.gsap.to(batch, {
        opacity: 1,
        duration: 1,
  ...
  _ScrollTrigger.ScrollTrigger.create({
    trigger: scale,
    animation: _gsap.gsap.fromTo(scale, {
      scale: 0.3
    }, {
      scale: 1
    }),
  ...
  _ScrollTrigger.ScrollTrigger.create({
    trigger: transform,
    animation: _gsap.gsap.fromTo(transform, {
      y: -100
    }, {
      y: 0
    }),
...
exports.initAnimateFade = initAnimateFade;

},{"../../vendor/ScrollTrigger.min":15,"../../vendor/gsap.min":16}],3:[function(require,module,exports){
"use strict";
...
var initAnimateIntro = function initAnimateIntro() {
  ...
  var blockIntro = document.querySelector('[data-animate="intro"]');
  if (!blockIntro) {
    return;
  }
  var blockScale = blockIntro.querySelector('.container');
  setTimeout(function () {
    blockIntro.classList.add('is-shown');
  }, 2000);
  _gsap.gsap.to(blockScale, {
    scale: 0.4,
    scrollTrigger: {
      trigger: blockScale,
      start: 'top 50%',
...
},{"../../vendor/ScrollTrigger.min":15,"../../vendor/gsap.min":16}],4:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initAnimateScroll = void 0;
var _gsap = require("../../vendor/gsap.min");
var _ScrollTrigger = require("../../vendor/ScrollTrigger.min");
var initAnimateScroll = function initAnimateScroll() {
  _gsap.gsap.registerPlugin(_ScrollTrigger.ScrollTrigger);
  var images = _gsap.gsap.utils.toArray('.scroll-slider__wrap');
  var imagesTl = _gsap.gsap.timeline({
    defaults: {
      ease: 'none'
    },
    scrollTrigger: {
...
exports.initAnimateScroll = initAnimateScroll;

},{"../../vendor/ScrollTrigger.min":15,"../../vendor/gsap.min":16}],5:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.curtainsAnimation = void 0;
var _gsap = require("../../vendor/gsap.min");
var _ScrollTrigger = require("../../vendor/ScrollTrigger.min");
var curtainsAnimation = function curtainsAnimation() {
  _gsap.gsap.registerPlugin(_ScrollTrigger.ScrollTrigger);
  var curtains = _gsap.gsap.utils.toArray('[data-text="curtains"]');
  curtains.forEach(function (curtain) {
    var curtainsText = curtain.querySelectorAll('.curtains__text');
    _gsap.gsap.to(curtainsText, {
...
exports.curtainsAnimation = curtainsAnimation;

},{"../../vendor/ScrollTrigger.min":15,"../../vendor/gsap.min":16}],6:[function(require,module,exports){
"use strict";
...
},{"../utils/scroll-lock":14}],7:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initShowHeader = void 0;
var _scrollLock = require("../utils/scroll-lock");
var initShowHeader = function initShowHeader() {
  var header = document.querySelector('.header');
  var scrollLock = new _scrollLock.ScrollLock();
  if (!header) {
    return;
  }
  var btnHeader = document.querySelector('.header__toggle');
...
exports.initShowHeader = initShowHeader;

},{"../utils/scroll-lock":14}],8:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initMapTwo = void 0;
var initMapTwo = function initMapTwo() {
  var maps = document.querySelector('[data-map=map-2]');
  if (!maps) {
    return;
  }
  ymaps.ready(function () {
    ...
    var myPlacemarkTwo = new ymaps.Placemark([52.60590456608306, 39.60577712955094], {
      balloonContentHeader: '<a href = "#">Зеленый театр.</a><br>' + '<span>Липецк, аллея Быханова</span>',
    ...
    var myPlacemarkThree = new ymaps.Placemark([52.60564247398761, 39.606099364439636], {
      balloonContentHeader: '<a href = "#">Тут вкусное мороженое</a><br>' + '<span>Липецкое мороженое</span>',
    ...
    var myPlacemarkFour = new ymaps.Placemark([52.604598057903615, 39.60557800952635], {
      balloonContentHeader: '<a href = "#">Колесо обозрения</a><br>' + '<span>Отсюда открывается прекрасный вид на город</span>',
    ...
    var myPlacemarkFive = new ymaps.Placemark([52.60564247398761, 39.604404208342224], {
      balloonContentHeader: '<a href = "#">Качели в парке</a><br>' + '<span>Отдохните после прогулки</span>',
    ...
    var myPlacemarkSix = new ymaps.Placemark([52.60545799564745, 39.60206901604345], {
      balloonContentHeader: '<a href = "#">Качели в парке</a><br>' + '<span>Отдохните после прогулки</span>',
      balloonContentBody: '<img src="img/content/swing.jpg" height="150" width="200">'
    }, {
      iconLayout: 'default#imageWithContent',
...
exports.initMapThree = void 0;
var _initMapZoom = require("./init-map-zoom");
var initMapThree = function initMapThree() {
  var maps = document.querySelector('[data-map=map-3]');
  if (!maps) {
    return;
  }
  ymaps.ready(function () {
...
exports.initMapThree = initMapThree;

},{"./init-map-zoom":10}],10:[function(require,module,exports){
"use strict";
...
var initZoomMap = function initZoomMap(ymap) {
  var messageBlock = document.querySelector('.map__message');
  if (!messageBlock) {
    return;
  }
  ...
  var hiddenMessage = function hiddenMessage() {
    messageBlock.classList.remove('is-active');
  };
  var enableScrollMapZoomOnKeydown = function enableScrollMapZoomOnKeydown(event) {
  ...
  var disableScrollMapZoomOnKeyup = function disableScrollMapZoomOnKeyup(event) {
...
var initMap = function initMap() {
  var maps = document.querySelector('[data-map=map-1]');
  if (!maps) {
    return;
  }
  ymaps.ready(function () {
